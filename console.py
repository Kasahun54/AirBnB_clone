#!/usr/bin/python3
"""
The version of this console v: 1.0.1
It Contains the entry point for command interpreter
"""
...
class HBNBCommand(cmd.Cmd):
    ...
    def my_errors(self, line, num_of_args):
        ...
        Args:
            line(any): gets the user input on command line
            num_of_args(int): number arguments
    ...
    def do_create(self, line):
        ...
        Args:
            line(args): Arguments to enter with a command: <class name>
            Ex: 'create User'
        ...
        """
        args[0] it contains class name, create new instance
    ...
    def do_show(self, line):
        ...
        Args:
            line(line): Enter with command <class name> <id>
            Ex: 'show User 123'
    ...
    def do_destroy(self, line):
        """It Deletes an instance of a certain class

        Args:
            line(args): Enter with command: <class name> <id>
            Ex: 'destroy User 123'
