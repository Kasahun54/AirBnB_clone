#!/usr/bin/python3
"""Module the test classes"""
import inspect
import pep8


class TestClassDocumentation():
    """Class for allowing us to test multiples classes"""
    ...
    def documentation(self):
        """Test the documentation of the module, class and methods"""
    ...
    def pep8(self, files):
        """Test the linter pep8 over the files"""
